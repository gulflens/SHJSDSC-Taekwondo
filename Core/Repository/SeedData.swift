...
public enum SeedData {
    ...
    public static func build() -> SeedBundle {
        ...
        // Demo credentials. The admin / TD / coach accounts all sign in with
        // password "12345678"; the developer / project-owner account uses its
        // own password — only the SHA-256 hash is stored, never the plaintext.
        let credentials = [
